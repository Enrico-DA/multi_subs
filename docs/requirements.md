...
- Codex exec auto-routing may use the system default Codex account as a reserve account only after at least one configured profile has current usage data and every such profile is at 100% weekly usage.
